...
execute()
{
  xrun $xrun_opts \
       ...
       -f run.f \
       -top glbl \
       +incdir+"$ref_dir/../../../../Full_FFT_System_Baremetal.gen/sources_1/bd/design_1/ipshared/ec67/hdl" \
       +incdir+"$ref_dir/../../../../Full_FFT_System_Baremetal.gen/sources_1/bd/design_1/ipshared/ee60/hdl" \
       +incdir+"../../../../Full_FFT_System_Baremetal.gen/sources_1/bd/design_1/ipshared/ec67/hdl" \
       +incdir+"../../../../Full_FFT_System_Baremetal.gen/sources_1/bd/design_1/ipshared/ee60/hdl" \
