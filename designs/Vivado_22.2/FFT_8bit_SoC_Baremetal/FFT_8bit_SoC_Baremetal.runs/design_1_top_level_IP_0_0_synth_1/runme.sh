...
HD_PWD='D:/Yannos/FILES/PROGRAMS/FPGA/VIVADO/Cora_Z7/Projects/Full_FFT_System_Baremetal/Full_FFT_System_Baremetal.runs/design_1_top_level_IP_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_top_level_IP_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_top_level_IP_0_0.tcl
