...
HD_PWD='D:/Yannos/FILES/PROGRAMS/FPGA/VIVADO/Cora_Z7/Projects/Full_FFT_System_Baremetal/Full_FFT_System_Baremetal.runs/design_1_processing_system7_0_1_synth_1'
cd "$HD_PWD"
