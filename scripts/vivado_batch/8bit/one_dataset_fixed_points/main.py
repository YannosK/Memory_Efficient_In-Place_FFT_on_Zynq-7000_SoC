...
if __name__ == "__main__":
    ...
    result = subprocess.run(
        # ['/c', 'vivado', '-mode', 'batch', '-source', 'temp_script.tcl'],
    ...
    # Call write_rel_error.py to calculate relative error
    subprocess.run([python_version, 'produce_rel_error.py', generics['width'], 
                    generics['resultfile'], generics['outfile'], str(sensor), str(points), str(dataset)])
