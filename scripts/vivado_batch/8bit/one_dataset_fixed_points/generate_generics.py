...
if __name__ == "__main__":
    ...
    generics_lookup = {
        ...
        #     "maxcount": 8,
        #     "width": 32,
        #     "RAM_file": FPGA_input_maindir + "8_samples/{dataset}_in.txt",
        #     "ROM_file": FPGA_twiddle_dir + "twiddles_8p.txt",
        #     "resultfile": FPGA_output_maindir + "8_samples/{dataset}_FPGA_out.txt",
        #     "outfile": output_maindir + "8_samples/{dataset}.txt"
        # },
        # 16: {
        #     "stages": 4,
        #     "stagebits": 3,
        ...
        #     "maxcount": 8,
        #     "width": 32,
        #     "RAM_file": FPGA_input_maindir + "16_samples/{dataset}_in.txt",
        #     "ROM_file": FPGA_twiddle_dir + "twiddles_16p.txt",
        #     "resultfile": FPGA_output_maindir + "16_samples/{dataset}_FPGA_out.txt",
        #     "outfile": output_maindir + "16_samples/{dataset}.txt"
        # },
        # 32: {
        #     "stages": 5,
        #     "stagebits": 3,
        ...
        #     "maxcount": 8,
        #     "width": 32,
        #     "RAM_file": FPGA_input_maindir + "32_samples/{dataset}_in.txt",
        #     "ROM_file": FPGA_twiddle_dir + "twiddles_32p.txt",
        #     "resultfile": FPGA_output_maindir + "32_samples/{dataset}_FPGA_out.txt",
        #     "outfile": output_maindir + "32_samples/{dataset}.txt"
        # },
    }
